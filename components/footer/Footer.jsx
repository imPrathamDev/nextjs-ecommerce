        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
            <div className="text-center sm:text-left">
              <p className="text-lg font-Cinzel font-medium text-primary-black">
                About Us
              </p>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="relative flex w-2 h-2 -mr-2">
                        <span className="absolute inline-flex w-full h-full bg-primary-light rounded-full opacity-75 animate-ping"></span>
                        <span className="relative inline-flex w-2 h-2 bg-primary-semi-light rounded-full"></span>
                      </span>
                    </a>
                  </li>
                </ul>
