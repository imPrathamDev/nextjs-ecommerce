            ...
            <div className="container mx-auto px-6 py-16">
                <div className="mx-auto">
                    <div>
                        ...
                        <p className="mt-2 text-gray-600">Listen to your favorite music today !</p>
                    </div>
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-3">
                        ...
                        <div className="relative flex flex-col justify-end overflow-hidden rounded-b-xl pt-6">
                            <div className="group relative flex cursor-pointer justify-between rounded-xl bg-primary-light before:absolute before:inset-y-0 before:right-0 before:w-1/2 before:rounded-r-xl before:bg-gradient-to-r before:from-transparent before:to-primary before:opacity-0 before:transition before:duration-500 hover:before:opacity-100">
                                ...
                                <img className="absolute z-50 -bottom-1 right-0 w-[9rem] transition duration-300 group-hover:scale-[1.4]" src='https://firebasestorage.googleapis.com/v0/b/replay-chat-dd920.appspot.com/o/test-placeholder.png?alt=media&token=d60dd20c-e70a-443a-9dcf-10cdda94aae3' alt="" />
                            </div>
                        </div>
                        ...
                        <div class="relative -mr-6 flex flex-col justify-end overflow-hidden rounded-b-xl pt-6 pr-6">
                            <div class="group relative flex cursor-pointer justify-between rounded-xl bg-orange-200 before:absolute before:inset-y-0 before:right-0 before:w-1/2 before:rounded-r-xl before:bg-gradient-to-r before:from-transparent before:to-orange-600 before:opacity-0 before:transition before:duration-500 hover:before:opacity-100">
                                ...
                                <img class="absolute -bottom-1 right-0 w-[7rem] transition duration-300 group-hover:scale-[1.4]" src="https://firebasestorage.googleapis.com/v0/b/replay-chat-dd920.appspot.com/o/test-placeholder.png?alt=media&token=d60dd20c-e70a-443a-9dcf-10cdda94aae3" alt="" />
                            </div>
                        </div>
