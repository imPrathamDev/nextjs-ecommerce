...
const Contact = () => {
  return (
    <section className="p-0 bg-contact-bg bg-cover bg-center bg-no-repeat bg-fixed bg-black flex flex-col items-center justify-center">
      <div className="text-center px-24 py-32 w-full h-full bg-primary-black/50">
        <div>
          ...
          <div className="flex items-center justify-between px-8 py-3 bg-primary-white/60 backdrop-blur-sm rounded-full max-w-3xl mx-auto my-6 text-xl">
            <input
              type="text"
              name=""
              id="email"
