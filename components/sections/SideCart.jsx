  ...
  useEffect(() => {
    setTotal(
      cartItems.reduce(
        (acc, curr) =>
          acc +
          products.filter((p) => p._id === curr._id)?.[0]?.discPrice * curr.qty,
        0
      )
    );
  }, [cartItems, products]);
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-primary-white shadow-xl">
                    <div className="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-xl font-semibold text-primary-black">
                          {" "}
                          Shopping cart{" "}
                        </Dialog.Title>
                        <div className="ml-3 flex h-7 items-center">
                          ...
                          >
                            ...
                            <svg
                              ...
                              className="h-6 w-6 transition-all transform group-hover:scale-125 group-hover:rotate-180"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                              strokeWidth={2}
                      ...
                      {!cartItems.length > 0 && (
                        <div className="w-full h-fit text-center flex flex-col mt-12 items-center justify-center">
                          <div className="relative w-60 h-60 overflow-hidden">
                            <Image
                              src={emptyCart}
                              layout="fill"
                              className="my-2 object-center object-cover"
                            />
                          </div>
