...
function Footer() {
  return (
<footer className="border border-t-[1px] border-[#E9E9E9]">
  <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <p
          className="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-500 sm:max-w-xs sm:mx-0 sm:text-left"
        >
      ...
      >
        <div className="text-center sm:text-left">
          <p className="text-lg font-Cinzel font-medium text-primary-black">About Us</p>
        ...
        <div className="text-center sm:text-left">
          <p className="text-lg font-Cinzel font-medium text-primary-black">Our Services</p>
        ...
        <div className="text-center sm:text-left">
          <p className="text-lg font-Cinzel font-medium text-primary-black">Helpful Links</p>
              ...
              <li>
                ...
                >
                  ...
                  <span className="relative flex w-2 h-2 -mr-2">
                    <span
                      className="absolute inline-flex w-full h-full bg-primary-light rounded-full opacity-75 animate-ping"
                    ></span>
                    <span
                      className="relative inline-flex w-2 h-2 bg-primary-semi-light rounded-full"
                    ></span>
                  </span>
                </a>
              </li>
        ...
        <div className="text-center sm:text-left">
          <p className="text-lg font-Cinzel font-medium text-primary-black">Contact Us</p>
