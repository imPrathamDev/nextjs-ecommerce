...
import productImage from '../../public/product-one.png'
  ...
  <div className="container px-5 py-12 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <div className='flex flex-col'>
            <Zoom>
            <Image alt="ecommerce" width={'400px'} height={'400px'} className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={productImage} />
            </Zoom>
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm font-semibold text-primary-semi-light tracking-widest">CATEGORY</h2>
        <h1 className="text-primary-black text-3xl font-medium font-Cinzel mb-1">The Catcher in the Rye</h1>
        ...
        <div className="flex items-center">
          <span className="font-Cinzel font-medium text-3xl text-primary-black"><span className='text-lg'>$</span>58.00</span>
