                                ...
                                <form method='POST'>
                                    ...
                                    <div className='flex items-center justify-between gap-1 mb-4'>
                                        <div>
                                            ...
                                            <input type="text" name="firstName" id="firstname" placeholder="Pratham" onChange={handlerChange} value={firstName} className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-primary-black focus:border-primary-semi-light dark:focus:border-primary-semi-light focus:ring-primary-semi-light focus:outline-none focus:ring focus:ring-opacity-40" />
                                        </div>
                                        <div>
                                            <label htmlFor="lstname" className="block font-Cinzel font-medium mb-2 text-sm text-gray-600">Last Name</label>
                                            <input type="text" name="lastName" id="lastname" placeholder="Sharma" onChange={handlerChange} value={lastName} className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-primary-black focus:border-primary-semi-light dark:focus:border-primary-semi-light focus:ring-primary-semi-light focus:outline-none focus:ring focus:ring-opacity-40" />
                                        </div>
                                    </div>
